<?php
 session_start();
$file_dir = 'C:\xampp\htdocs\semina\data\\';
$num=$_REQUEST["num"];
...
try {
	...
	try {
		...
		$sql = "update phptest.concert set hit=? where num=?";
		// 조회수 증가
		$stmh = $pdo->prepare($sql);
	...
	?>
	 ...
	 <body>
	 <div id="wrap">
	 <div id="header"><?php include "../lib/top_login2.php";
	?></div> 
	  <div id="menu"><?php include "../lib/top_menu2.php";
	?></div> 
	  <div id="content">
	     <div id="col1">
		<div id="left_menu"><?php include "../lib/left_menu.php";
	?></div>
	     </div>
	      <div id="col2">
